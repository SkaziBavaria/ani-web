...
const migrationFields = ['provider', 'hianimeId', 'legacyAnidbId', 'providerMigrationStatus', 'providerMigrationReason', 'providerMigratedAt', 'providerMigrationAttemptedAt'];

function mergeAnimeMigration(current, migrated) {
  if (!current || current.hianimeId) return current;
